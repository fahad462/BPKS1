                        ...
                        <table border="1" style="width:50%"
                            ...
                            @foreach ($employees as $employee)
                                <tr>
                                    ...
                                    @endforeach
                                    <td>
                                        <button onclick="return openmodal(this)"
                                                id="{{ $employee->{'email'} }}"
                                                type="button"
                                                class="btn btn-danger btn-md">Action
                                        </button>
                                    </td>
                                </tr>
                                @php ($id=$id+1)
                                        ...
                                        <form role="form">
                                            <div class="form-group">
                                                <label for="a"><span
                                                    ...
                                                    Update This Employees Designation
                                                </label>
                                                <label id="sets" hidden></label>
                                                <select class="form-control" id="s1">
                                                    <option disabled selected value>Please Select an Option..
                                                    </option>
                                            ...
                                            <script>
                                                function openmodal(var1) {
                                                    $("#myModal").modal();
                                                    var1 = var1.id;
                                                    var2 = document.getElementById('s1').value;
                                                    document.getElementById('sets').value = var1;
                                                };
                                            </script>
                                            <script>
                                                function queryw() {
                                                    let birth = document.getElementById('sets').value;
                                                    // alert(birth);
                                                    var2 = document.getElementById('s1').value;
                                                    if (confirm('Are you Sure?') == false) return 0;
                                                    $.post('/admin/roles/change', {
                                                            "_token": "{{ csrf_token() }}",
                                                            birth: birth,
                                                            id: var2
                                                        }
