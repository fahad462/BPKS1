...
@section('content')
    <div class="col-md-1">
        ...
        function showForm() {
            var decision=document.getElementById('check');
            var val = decision.options[decision.selectedIndex].value;
            if(val=="People"){
                document.getElementById('pupil').style.display="block";
                document.getElementById('pupil1').style.display="block";
                document.getElementById('pupil').required=true;
                document.getElementById('orgi').style.display="none";
                document.getElementById('orgi1').style.display="none";
                document.getElementById('orgi2').style.display="none";
                ...
                document.getElementById('orgi').style.display="block";
                document.getElementById('orgi1').style.display="block";
                document.getElementById('orgi2').style.display="block";
                document.getElementById('pupil').style.display="none";
                document.getElementById('pupil1').style.display="none";
                ...
                document.getElementById("pupil").removeAttribute("required");
            } else {
                document.getElementById('orgi').style.display="none";
                document.getElementById('orgi1').style.display="none";
                document.getElementById('orgi2').style.display="none";
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.services.donor.post') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select onchange="return showForm()" id="check" name="check"
                            ...
                            <div class="form-group row">
                                <label for="transition-id" class="col-md-4 col-form-label text-md-right">{{ __('Donation Transition ID') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="perspective" class="col-md-4 col-form-label text-md-right">{{ __('Perspective of the Donor') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="donation-duration" class="col-md-4 col-form-label text-md-right">{{ __('Donation Interval') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="postal-code" class="col-md-4 col-form-label text-md-right">{{ __('Donor Postal Code') }}</label>
                            ...
                            <div style="display: none;" id="pupil" class="form-group row">
                                <label for="donor-name" class="col-md-4 col-form-label text-md-right">{{ __('Donor Name') }}</label>
                                <div class="col-md-6">
                            ...
                            <div style="display: none;" id="pupil1" class="form-group row">
                                <label for="passport" class="col-md-4 col-form-label text-md-right">{{ __('Passport No') }}</label>
                                <div class="col-md-6">
                            ...
                            <div style="display: none;" id="orgi" class="form-group row">
                                <label for="org-name"
                            ...
                            <div style="display: none;" id="orgi1" class="form-group row">
                                <label for="org-type"
                            ...
                            <div style="display: none;" id="orgi2" class="form-group row">
                                <label for="reg-no"
